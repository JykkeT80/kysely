...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      vaihtoehdot.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Kylla", "oikein", true], t1, t2));
      vaihtoehdot.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Ei", "oikein", false], t1, t2));
      kysymykset.push(A.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Siistia?", "vaihtoehdot", vaihtoehdot], t1, t2));
  ...
  A.lisaaVastausvaihtoehto_closure.prototype = {
    call$1(e) {
      ...
      if (A.boolConversionCheck(A._asBoolS(J.$index$asx(this.vaihtoehto, "oikein"))))
        ...
        B.DivElement_methods.set$text(t1, "vaarin!");
    },
    $signature: 4
  };
  (function aliases() {
